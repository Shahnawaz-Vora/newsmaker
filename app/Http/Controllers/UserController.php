...
class UserController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->clients = [
            ...
            "logo1" => asset('asset/images/clients/abbott.webp'),
            "logo2" => asset('asset/images/clients/aimil.webp'),
            "logo3" => asset('asset/images/clients/finlaw.webp'),
            "logo4" => asset('asset/images/clients/fortis_hospital.webp'),
            "logo5" => asset('asset/images/clients/marching_sheep.webp'),
            "logo6" => asset('asset/images/clients/metro_hospital.webp'),
            "logo7" => asset('asset/images/clients/okaya.webp'),
            "logo8" => asset('asset/images/clients/star_imaging_and_path_lab.webp'),
            "logo9" => asset('asset/images/clients/tac_security.webp'),
            "logo10" => asset('asset/images/clients/wockhardt_hospitals.webp'),
            "logo11" => asset('asset/images/clients/cyble.webp'),
            "logo12" => asset('asset/images/clients/corover.webp')
